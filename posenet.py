...
class poseNet(nn.Module):
    def __init__(self,layers):
        ...
        self.upsample2 = nn.Upsample(size=(120,120),mode='bilinear',align_corners=True)
        self.upsample3 = nn.Upsample(size=(120,120),mode='bilinear',align_corners=True)

        self.concat = Concat()
        self.conv2 = nn.Conv2d(512,512,kernel_size=3,stride=1,padding=1)
        self.convfin = nn.Conv2d(512,17,kernel_size=1,stride=1,padding=0)
